...
public class ProductService {
    ...
    public Page<Product> getProducts(GetProductsRequest request, Pageable pageable) {
        ...
        if (request.getPartialName() != null && request.getMinimumQuantity() != null && request.getMinimumPrice() != null && request.getMaximumPrice() != null) {
            ...
            return productRepository.findByNameContainingAndPriceBetweenAndQuantityGreaterThanEqual(request.getPartialName(), request.getMinimumPrice(), request.getMaximumPrice(), request.getMinimumQuantity(), pageable);
        }
